...
namespace Qr_Code_Configurator.View
{
    ...
    public partial class PageMain : UserControl
    {
        public PageMain()
        {
            ...
            vCardText += "Hamed Momen\r\n";
            vCardText += "TEL;WORK;VOICE:+98 921 431 23 99\r\n";
            vCardText += "EMAIL;PREF;INTERNET:hamerstandr@live.com\r\n";
            vCardText += "END:VCARD";
        ...
        private void Tab2ECICombo_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (Tab2ECICombo != null)
            {
                ...
                {
                    Tab2InputBox.Text = "QR Code by hamerstandr";
                    if (QRCode2 != null)
        ...
        private void TextBlock_Color(object sender, MouseButtonEventArgs e)
        {
            RadWindow.Alert(new DialogParameters()
            {
                Header = new TextBlock()
